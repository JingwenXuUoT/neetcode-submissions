class Solution:
    def findDuplicate(self, nums: List[int]) -> int:
        ...
        # We can use Floyd's cycle detection algorithm: fast, slow pointer
        # the point where slow and fast meet again is the entry point of the cycle, also the duplicate value
        # TC: O(n), SC: O(1)
        slow = 0
        fast = 0
